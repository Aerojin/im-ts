...
class ImageCell extends MessageCell<any, ImageCellState> {
  taskListener!: any;
      ...
      <div style={{ position: "relative" }}>
        ...
        {this.state.loading && scaleSize.width > 32 && (
          <i className="loading-box">
            <img className="loading-icon" src={require("./loading.png")} alt="" />
  ...
  render() {
    ...
    return (
      <MessageBase hiddeBubble={false} context={context} message={message}>
        <div
