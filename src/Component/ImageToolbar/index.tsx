// import { ConversationContext, ImageContent, WKApp } from "@tsdaodao/base";
...
export default class ImageToolbar extends Component<ImageToolbarProps, ImageToolbarState>{
    ...
    componentDidMount() {
        ...
        // conversationContext.setDragFileCallback((file: any)=>{
        //     self.showFile(file);
        // })
    }
            ...
            <div className="wk-imagedialog-content">
                ...
                <div className="wk-imagedialog-content-body">
                    ...
                    <div className="wk-imagedialog-footer" >
                        ...
                        <button onClick={onSend} className="wk-imagedialog-footer-okbtn" disabled={!canSend} style={{ backgroundColor: canSend ? '#e46342' : 'gray' }}>发送</button>
                    </div>
                </div>
