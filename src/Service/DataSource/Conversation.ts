...
import { IConversationProvider, SyncMessageOptions } from "./DataProvider";
...
export class ConversationProvider implements IConversationProvider {
  ...
  async syncGetMessages(
    ...
    var resp = await this.WKApp.apiClient.post(`message/channel/sync`, {
      limit: limit,
      channel_id: channel.channelID,
      channel_type: channel.channelType,
  ...
  async syncMessageExtras(
    ...
    let messageExtraObjs = await this.WKApp.apiClient.post(`message/extra/sync`, {
      channel_id: channel.channelID,
      channel_type: channel.channelType,
